...
| `gradlew graphDump -Dorg.gradle.isolated-projects=false`                  | Dumps project dependencies to a mermaid file                  |
| `gradlew graphUpdate -Dorg.gradle.isolated-projects=false`                | Updates Markdown file with the corresponding dependency graph |
...
- [![📋 Kotlin Binary Compatibility Validation](https://github.com/SimonMarquis/Android-Playground/actions/workflows/kotlin-binary-compatibility-validation.yaml/badge.svg)](https://github.com/SimonMarquis/Android-Playground/actions/workflows/kotlin-binary-compatibility-validation.yaml)
